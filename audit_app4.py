...
# ═══════════════════════════════════════
    ...
    # Session state default хамгаалалт
    if 'analysis_done' not in st.session_state:
        st.session_state['analysis_done'] = False
    if 'rm_all' not in st.session_state:
        st.session_state['rm_all'] = pd.DataFrame()
    if 'mo_all' not in st.session_state:
        st.session_state['mo_all'] = pd.DataFrame()
    if 'txn_result' not in st.session_state:
        st.session_state['txn_result'] = pd.DataFrame()
